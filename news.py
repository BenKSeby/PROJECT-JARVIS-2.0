...
class News():
    ...
    def headlines(self ,query):
        ...
        try:
            headline_1 = self.driver.find_element_by_xpath('//*[@id="content"]/div/div/div[1]/h2/a')
            headline_2 = self.driver.find_element_by_xpath('//*[@id="content"]/div/div/div[2]/h2/a')
            headline_3 = self.driver.find_element_by_xpath('//*[@id="content"]/div/div/div[3]/h2/a')
            headline_4 = self.driver.find_element_by_xpath('//*[@id="content"]/div/div/div[4]/h2/a')
            #headline_5 = self.driver.find_element_by_xpath('//*[@id="adsdivLyr"]/div/a/h3')
            headline_6 = self.driver.find_element_by_xpath('//*[@id="content"]/div/div/div[6]/h2/a')
        except:
            pass
