...
class Movie():
    ...
    def movie_review(self, name):
        ...
        search1 = self.driver.find_element_by_xpath('/html/body/div[1]/div[3]/form/div[1]/div[1]/div[1]/div/div[2]/input')
        search1.click()
        ...
        submit1 = self.driver.find_element_by_xpath('/html/body/div[1]/div[3]/form/div[1]/div[1]/div[2]/div[2]/div[5]/center/input[1]')
        submit1.click()
        time.sleep(60)
